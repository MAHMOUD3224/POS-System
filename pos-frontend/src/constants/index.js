...
export const menus = [
  { id: 1, name: "Starters", bgColor: "color1" ,icon: "🍲", items: startersItem },
  { id: 2, name: "Main Course", bgColor: "color2" ,icon: "🍛", items: mainCourse },
  { id: 3, name: "Beverages", bgColor: "color3" ,icon: "🍹", items: beverages },
  { id: 4, name: "Soups", bgColor: "color4" ,icon: "🍜", items: soups },
  { id: 5, name: "Desserts", bgColor: "color5" ,icon: "🍰", items: desserts },
  { id: 6, name: "Pizzas", bgColor: "color6" ,icon: "🍕", items: pizzas },
  // todos: remove this item
  { id: 7, name: "Alcoholic Drinks", bgColor: "color7" ,icon: "🍺", items: alcoholicDrinks },
  { id: 8, name: "Salads", bgColor: "color8" ,icon: "🥗", items: salads }
]
